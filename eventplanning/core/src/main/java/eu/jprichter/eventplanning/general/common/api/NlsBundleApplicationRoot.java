...
public interface NlsBundleApplicationRoot extends NlsBundle {
  ...
  /**
   * @see eu.jprichter.eventplanning.general.common.api.exception.IllegalEntityStateException
   *
  ...
  /**
   * @see eu.jprichter.eventplanning.general.common.api.exception.NoActiveUserException
   *
   * @return the {@link NlsMessage}.
   */
