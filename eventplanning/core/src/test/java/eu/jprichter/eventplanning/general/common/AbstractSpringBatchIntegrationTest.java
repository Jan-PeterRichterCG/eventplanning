package eu.jprichter.eventplanning.general.common;
...
import eu.jprichter.eventplanning.general.common.api.security.UserData;
...
public abstract class AbstractSpringBatchIntegrationTest extends ComponentTest {
  ...
  /**
   * @param login (missing JavaDoc in generated code)
   * @param password (missing JavaDoc in generated code)
   * @param permissions (missing JavaDoc in generated code)
   */
